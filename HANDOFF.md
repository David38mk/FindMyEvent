...
**Next:** Phase 1 backlog EMPTY → do the Phase 1 exit review against PLAN.md (exit: stranger with the APK finds an event tonight). Name decision still open: Merak vs Vajb (§5.7). OSM places cleanup pass still pending (dupes flagged 08-19). Event-source research on David.
**Blocked:** -
